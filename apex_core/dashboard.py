# dashboard.py
# 🦅 ARGUS MISSION CONTROL - V3.3 (REVERT & RESTORE)
...
# --- CUSTOM STYLING (YOUR ORIGINAL V2.3 CSS) ---
st.markdown("""
<style>
...
def get_cortex_state():
    """FIXED: Now scrapes log directly to find your 0.90 multiplier."""
    log_path = project_root / "argus.log"
    state = {"conviction_score": 50, "regime": "Searching...", "risk_mult": 0.50}
    if log_path.exists():
        try:
...
def get_auto_entry():
    """FIXED: Pulls from trade_state.json so you don't have to type it."""
