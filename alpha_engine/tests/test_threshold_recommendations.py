...
def test_threshold_reco_basic_and_guardrail(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setenv("AE_THR_RECO_WINDOW_H", "72")
    monkeypatch.setenv("AE_THRESHOLD_JOIN_MIN", "5")
    monkeypatch.setenv("AE_THR_RECO_MIN_LABELS", "4")
    monkeypatch.setenv("AE_THR_RECO_MIN_PREC", "0.75")
    monkeypatch.setenv("AE_THR_RECO_STRATEGY", "precision_min_recall_max")
    monkeypatch.setenv("AE_THR_RECO_MAX_DELTA", "0.10")
    monkeypatch.setenv("AE_THR_RECO_ALLOW_LARGE_JUMP", "false")
...
def test_threshold_reco_insufficient_and_demo(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setenv("MODELS_DIR", str(models))
    monkeypatch.setenv("AE_THR_RECO_WINDOW_H", "72")
    monkeypatch.setenv("AE_THR_RECO_MIN_LABELS", "10")
