...
def _mk_snapshot_png(summary: Dict[str, Any], out_png: Path) -> None:
    ...
    try:
        ...
        lines = [
            "alphaengine Governance — 72h Snapshot",
...
def _render_html(manifest: Dict[str, Any], png_data_uri: str | None) -> str:
    ...
    header = f"""
    <div class="wrap">
      <h1>alphaengine Governance Dashboard ({wh}h)</h1>
      <div class="meta">
        Generated <b>{gen}</b>
      ...
      <div class="footer">Artifacts generated by alphaengine CI • HTML is self-contained (no external assets).</div>
    </div>
    """
