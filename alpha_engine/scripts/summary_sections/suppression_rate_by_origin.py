...
def _candidate_files(logs_dir: Path) -> List[Path]:
    ...
    Looks for common names used in alphaengine tests/CI.
    """
    names = [
        "candidates.jsonl",
...
def append(md: List[str], ctx: SummaryContext) -> None:
    ...
    """
    window_h = int(os.getenv("AE_SUPPRESSION_WINDOW_H", str(_DEF_WINDOW_H)))
    join_min = int(os.getenv("AE_TRIGGER_JOIN_MIN", str(_DEF_JOIN_MIN)))
