alphaengine Signal Engine – Tasklist (May 2024)

This doc tracks tactical engineering steps for alphaengine’s signal engine as we move from passive sentiment logging to active signal generation and future model integration.
