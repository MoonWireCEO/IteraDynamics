"""
SOL State Machine v1 (Layer 2) — low-turnover research sleeve.
...
STATE_KEY = "_sg_sol_state_machine_v1"
...
def generate_intent(
    ...
    **kwargs: Any,
    ...
    # Reuse identical logic; swap state namespace marker for SOL in meta if present.
